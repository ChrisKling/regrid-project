      ...
      return (
        <>
          ...
          <Box  sx={{ background: "#d4df9e", padding: '75px'  }}>
            <section>
              <div>
                <h6> {userProfile.email} - User Email </h6>
              </div>
              <div>
              ...
              <div>
                <img src={imgRef} alt='myIMG' style={{maxWidth: '128px', maxHeight: '128px'}} />
              </div>
            </section>
            <section>
              <div>
          ...
          <section>
            <div>
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <br/>
                    <Button disabled={loading} className='w-100' type='submit'>Create Profile</Button>
                </form>
            </div>
          </section>
        </Box>
